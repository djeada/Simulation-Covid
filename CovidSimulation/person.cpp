...
// some cooperative people will also rarely move in close proximity to their
// houses for shoping or to the doctor
...
enum stages_of_disease Person::getDiseaseStatus() { return status; }

void Person::setDiseaseStatus(enum stages_of_disease x) { status = x; }
...
Location *Person::getLocation() { return current_location; }

Location *Person::getHome() { return home_location; }
